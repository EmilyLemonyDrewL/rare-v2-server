# Generated by Django 4.1.3 on 2024-06-11 20:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admin_one_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='admin_one', to='rareapi.rareuser')),
                ('admin_two_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='admin_two', to='rareapi.rareuser')),
